...
int main()
{
    ...
    std::cout
        ...
        << foundNet->name
        << " connections="
        << foundNet->connections.size()
        << '\n';

    std::cout
        << "component_model test: PASS\n";
